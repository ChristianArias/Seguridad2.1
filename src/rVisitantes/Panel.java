...
public class Panel extends javax.swing.JInternalFrame {
    ...
    public Panel() {
        ...
        setTitle("Visitantes "+Sesion.nombreagencia);
    ...
    DefaultTableModel cargar(){
        ...
        try{
            String sql = "SELECT * FROM vistaprovedores WHERE "
                    + "(empresa LIKE ? OR gafette LIKE ? OR nombre LIKE ?) AND _agencia LIKE ? AND activo != 0";
            ...
            while(rs.next()){
                ...
                if(Inicio.Sesion.admin){
                    registros[4] = rs.getString("creador");
                    registros[5] = rs.getString("editor");
                    registros[6] = rs.getString("fechaAct");
                }
